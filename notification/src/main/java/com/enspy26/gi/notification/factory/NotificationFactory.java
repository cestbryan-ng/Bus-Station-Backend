package com.enspy26.gi.notification.factory;
...
public class NotificationFactory {
    ...
    public static NotificationEvent createVoyageCancelledEvent(Voyage voyage, UUID recipientId, RecipientType recipientType) {
        Map<String, Object> variables = new HashMap<>();
        variables.put("voyageTitle", voyage.getTitre());
        variables.put("voyageDate", voyage.getDateDepartPrev());
        variables.put("voyageDestination", voyage.getLieuArrive());
    ...
    public static NotificationEvent createEmployeeAddedEvent(EmployeAgenceVoyage employe, User user, AgenceVoyage agence) {
        Map<String, Object> variables = new HashMap<>();
    ...
    public static NotificationEvent createReservationCreatedEvent(Reservation reservation, Voyage voyage, UUID agenceId) {
        Map<String, Object> variables = new HashMap<>();
        variables.put("reservationId", reservation.getIdReservation().toString());
        variables.put("voyageTitle", voyage.getTitre());
        variables.put("passengerCount", reservation.getNbrPassager());
